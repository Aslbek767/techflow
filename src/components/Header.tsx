      ...
      >
        <div className="p-6 flex flex-col h-full">
          ...
          <nav className="flex flex-col space-y-4 text-lg">
            <Link href={`/${locale}`} className="text-white hover:text-blue-300 transition-colors" onClick={handleMobileNavClick}>{t('home')}</Link>
            <Link href={`/${locale}/about`} className="text-white hover:text-blue-300 transition-colors" onClick={handleMobileNavClick}>{t('about')}</Link>
            <Link href={`/${locale}/contact`} className="text-white hover:text-blue-300 transition-colors" onClick={handleMobileNavClick}>{t('contact')}</Link>
            <Link href={`/pages/tag/${locale}`} className="text-white hover:text-blue-300 transition-colors" onClick={handleMobileNavClick}>{t('resources')}</Link>
          </nav>
